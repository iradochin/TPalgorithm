...
void split (pTreapNode in, int data, pTreapNode& l, pTreapNode& r)
{
...
void insertDecTree (pTreapNode& root, pTreapNode in)
{
...
void insertBinaryTree (pTreapNode& in, int data)
{
...
size_t getHeight(TreapNode *root)
{
...
size_t getWidth (TreapNode* in, size_t level)
{
...
int getMaxWidth (TreapNode* root)
{
